    ...
    1: [function (a, e, t) { "use strict"; Object.defineProperty(t, "__esModule", { value: !0 }); var i, o = t.dificuldade = void 0; (i = o || (t.dificuldade = o = {}))[i.facil = 0] = "facil", i[i.medio = 1] = "medio", i[i.dificil = 2] = "dificil" }, {}], 2: [function (a, e, t) { "use strict"; Object.defineProperty(t, "__esModule", { value: !0 }); var i = a("./dificuldade.enum"); Object.defineProperty(t, "dificuldade", { enumerable: !0, get: function () { return i.dificuldade } }) }, { "./dificuldade.enum": 1 }], 3: [function (a, e, t) { "use strict"; var i = a("./quiz/BancoQuestoes"), o = a("./quiz/Quiz"); (new Image).src = "img./spin.gif", new o.Quiz(new i.BancoQuestoes).run() }, { "./quiz/BancoQuestoes": 4, "./quiz/Quiz": 5 }], 4: [function (a, e, t) {
        ...
        "use strict"; Object.defineProperty(t, "__esModule", { value: !0 }), t.Quiz = void 0; var i = function () { function i(a, e) { for (var t = 0; t < e.length; t++) { var i = e[t]; i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(a, i.key, i) } } return function (a, e, t) { return e && i(a.prototype, e), t && i(a, t), a } }(), o = a("../telas/ganhou.screen"), s = a("../telas/erro.screen"), n = a("../telas/tempo.screen"), r = a("../telas/questao.screen"), u = a("../utils/routes"), c = a("../telas/splash.screen"), l = a("../interfaces/index"); var d = window.jQuery; t.Quiz = function () {
            function e(a) {
                ...
                }(this, e), this._banco = a, this._questoes = Array.apply(null, Array(7)).map(function () { return { dificuldade: l.dificuldade.facil, conjunto: "educa" } }), this.score = 0, this.threshold = 5, this.paginaAtual = 0, this.timer = 0, this.questaoAtual = null, this.intervalId = null, this.htmlContainer = document.querySelector("#wrapper")
            } return i(e, [{
        ...
        , { "../interfaces/index": 2, "../telas/erro.screen": 7, "../telas/ganhou.screen": 8, "../telas/questao.screen": 9, "../telas/splash.screen": 10, "../telas/tempo.screen": 11, "../utils/routes": 13 }], 6: [function (a, e, t) {
            "use strict"; Object.defineProperty(t, "__esModule", { value: !0 }); t.banco = {
                educa: {
                    0: [{ id: 1, pergunta: "O que significa a sigla B3??", dificuldade: 0, resposta: "Brasil, Bolsa, Balcão", falsas: ["Brasil, Bolsa, Bal", "Brasil, Bolivia, Barcelona", "Brasil, Banco, Balcão", "Banco, Bolsa, Balcão"], conjunto: "educa" },



                    { id: 2, pergunta: "Quem exerce o controle de crédito na economia?", dificuldade: 0, resposta: "Bacen ", falsas: ["Banco do Brasil"], conjunto: "educa" }, 
                    
                    { id: 3, pergunta: "As Sociedades Distribuidoras de Títulos e Valores Mobiliários são fiscalizadas?", dificuldade: 0, resposta: "Apenas CVM ", falsas: ["Sul", "CMN e Bacen"], conjunto: "educa" }, 
                    
                    { id: 4, pergunta: "Responsável por regular, fiscalizar e garantir o bom funcionamento dos mercados de capitais nas Bolsas de Valores?", dificuldade: 0, resposta: "CVM", falsas: ["Um caju", "Bovespa",], conjunto: "educa" }, 
                    ...
                    { id: 10, pergunta: "Órgão responsável pela regulamentação e fiscalização dos Fundos de Investimento?", dificuldade: 0, resposta: "CVM", falsas: ["Susep"], conjunto: "educa" }, 
                    
                    { id: 11, pergunta: "Qual o país do mundo com a maior extensão territorial?", dificuldade: 0, resposta: "Rússia", falsas: ["Canadá"], conjunto: "educa" }, 
                    
                    { id: 12, pergunta: "As Distribuidoras de Títulos e Valores Mobiliários estão autorizadas a executar os serviços abaixo, com exceção de?", dificuldade: 0, resposta: "Administrar títulos de capitalização", falsas: ["Praticar operações no mercado de câmbio de taxas flutuantes"], conjunto: "educa"
                    }, 
                    
                    { id: 13, pergunta: "Dentre as funções da Comissão de Valores Mobiliários (CVM)?", dificuldade: 0, resposta: "Garantir o bom funcionamento da bolsa de valores", falsas: ["Aprovar orçamentos de crédito da economia"], conjunto: "educa" }, 
                    
                    { id: 14, pergunta: "Instituição financeira autorizada a administrar Fundos e Clubes de Investimento?", dificuldade: 0, resposta: "Corretora de Títulos e Valores Mobiliários", falsas: ["Banco Central"], conjunto: "educa" }, 
                    ...
                    { id: 16, pergunta: "Uma das funções do Banco Central?", dificuldade: 0, resposta: "Oferecer redesconto de liquidez ", falsas: ["Desenvolver o mercado de valores mobiliários"], conjunto: "educa" }, 
                    
                    { id: 17, pergunta: "É responsabilidade do Banco Central?", dificuldade: 0, resposta: "Decidir a taxa de juros de redesconto ", falsas: ["Desenvolver o mercado de valores mobiliários"], conjunto: "educa" }, 
                    
                    {id: 18, pergunta: "Atuam na intermediação nos pregões de bolsa de valores e mercadorias?", dificuldade: 0, resposta: "Corretoras e Distribuidoras de Valores Mobiliários ", falsas: ["Corretoras de Valores Mobiliários"], conjunto: "educa" }, 
                    
                    { id: 19, pergunta: "Competência exclusiva do Bacen?", dificuldade: 0, resposta: "Fiscalizar as instituições financeiras", falsas: ["Aprovar os orçamentários de moeda e crédito"], conjunto: "educa" }, 
                    
                    { id: 20,  pergunta: "Responsável por autorizar (o funcionamento) e fiscalizar as instituições financeiras?", dificuldade: 0, resposta: "Banco Central", falsas: ["Comissão de Valores Mobiliários"], conjunto: "educa" }, 
                    
                    { id: 21, pergunta: "Dentre as carteiras de um banco múltiplo, a carteira que apenas os bancos públicos podem operar é?", dificuldade: 0, resposta: "Desenvolvimento", falsas: ["Comercial"], conjunto: "educa" }, 
                    
                    { id: 22, pergunta: "Efetuar, em nome do Tesouro Nacional, compra e venda de títulos públicos é uma atribuição?", dificuldade: 0, resposta: "Do Banco Central do Brasil – Bacen ", falsas: ["Do Sistema Especial de Liquidação e Custódia – Selic"], conjunto: "educa" }, 
                    
                    { id: 23, pergunta: "O mercado de previdência aberta e capitalização é supervisionado pelo órgão?", dificuldade: 0, resposta: "Susep", falsas: ["CNSP (Conselho Nacional de Seguros Privados)"], conjunto: "educa" }, 
                    ...
                    { id: 28, pergunta: "Quanto maior exposição ao risco maior a lucratividade?", dificuldade: 0, resposta: "Certo", falsas: ["Errado"], conjunto: "educa" }, 
                    
                    { id: 29, pergunta: "A melhor forma de aprender operar é ir direto para conta real?", dificuldade: 0, resposta: "Errado", falsas: ["Certo"], conjunto: "educa" }, 
                    
                    { id: 30, pergunta: "Mercado de ações envolve baixo risco?", dificuldade: 0, resposta: "Errado", falsas: ["Certo"], conjunto: "educa" }, 
                    
                    {
                        id: 31, pergunta: "Quanto mais volatil o mercado, melhor de operar ?", dificuldade: 0, resposta: "Errado", falsas: ["Certo"], conjunto: "educa" }, 
